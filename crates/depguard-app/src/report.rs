...
pub fn parse_report_json(text: &str) -> anyhow::Result<ReportVariant> {
    let value: serde_json::Value = serde_json::from_str(text).context(format!(
        "Failed to parse report file as JSON. \
         Ensure the report file contains valid JSON. \
         Common issues: missing commas, unescaped quotes, truncated content, or encoding problems. \
         Input length: {} bytes",
        text.len()
    ))?;
    ...
    match schema.as_str() {
        SCHEMA_REPORT_V2 | SCHEMA_SENSOR_REPORT_V1 => {
            let report: DepguardReportV2 = serde_json::from_value(value).context(format!(
                "Failed to parse report with schema '{}' as a valid depguard v2 report. \
                     ...
                     Ensure the report was generated by a compatible version of depguard.",
                schema
            ))?;
        ...
        _ => {
            ...
            if let Ok(report) = serde_json::from_value::<DepguardReportV2>(value.clone()) {
                ...
                anyhow::bail!(
                    "Unknown report schema: '{}'. Expected one of: '{}', '{}', '{}', or '{}'. \
                     Ensure the report file was generated by depguard and has not been modified. \
                     Supported schemas: depguard.report.v1, depguard.report.v2, sensor.report.v1, receipt.envelope.v1",
                    schema,
                    SCHEMA_REPORT_V1,
                    SCHEMA_REPORT_V2,
