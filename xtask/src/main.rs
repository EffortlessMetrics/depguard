...
"#,
    ...
    fn run_with_args_help_and_unknown() {
        run_with_args(&["xtask".to_string(), "help".to_string()]).expect("help");
        let err = run_with_args(&["xtask".to_string(), "nope".to_string()]).unwrap_err();
    ...
    fn run_with_args_emit_and_validate_schemas() {
        with_temp_root(|_root| {
            run_with_args(&["xtask".to_string(), "emit-schemas".to_string()]).expect("emit");
            run_with_args(&["xtask".to_string(), "validate-schemas".to_string()])
                .expect("validate");
        });
    }
    ...
    fn run_with_args_conform_and_conform_full() {
        with_temp_root(|root| {
            ...
            run_with_args(&["xtask".to_string(), "conform".to_string()]).expect("conform");
            run_with_args(&["xtask".to_string(), "conform-full".to_string()])
                .expect("conform-full");
        });
    }
    ...
    fn run_with_args_print_schema_ids_and_explain() {
        run_with_args(&["xtask".to_string(), "print-schema-ids".to_string()])
            .expect("print-schema-ids");
        run_with_args(&["xtask".to_string(), "explain-coverage".to_string()])
