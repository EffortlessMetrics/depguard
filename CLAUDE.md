...
1. **Golden fixtures**: Byte-stable `report.json` and `comment.md` in `tests/fixtures/`
...
Located in `schemas/`:
- `receipt.envelope.v1.json` — Top-level envelope (vendored contract)
- `depguard.report.v1.json` — depguard-specific findings and verdict
